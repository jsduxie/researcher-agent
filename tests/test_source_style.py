...
# Model names belong in app_config (seeded from config/digest.example.yaml), not source. The pattern catches any `gemini-<version>-<flavour>` literal so future regressions trip the guard.
