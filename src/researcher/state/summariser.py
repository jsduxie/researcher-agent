...
def parse_summary_response(response_text):
	...
	# Sanitise invalid JSON escapes before json.loads
	# Gemini may emit literal backslashes (e.g. from paper maths)
	# like \cite, \frac that are not valid JSON escape sequences.
